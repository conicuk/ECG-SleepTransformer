...
WINDOW_SEC = 150  # seconds for window length
...
# 2) IHR: QRS find → IBI → filtering → IHR → z-score → 2 Hz interpolation
...
# 3) EDR: QRS signed-area → baseline → subtraction → z-score → 2 Hz interpolation
...
def visualize_ihr_edr(ecg, ihr, edr, fs, out_dir, basename, epoch_idx=0):
...
def main():
    ...
    parser.add_argument("--original_data_dir", type=str, default="./shhs1_IHR_EDR_class4", #default: save directory name
