...
def main():
    ...
    parser.add_argument("--original_data_dir", type=str, default="./shhs2_IHR_EDR_class4",
    ...
    for file_id in range(len(edf_fnames)):
        ...
        fs = raw.info['sfreq']
        print(f"🔍 Changed sampling rate: {fs} Hz")
        ...
        # vis_dir = os.path.join(args.original_data_dir, "visualizations2")
